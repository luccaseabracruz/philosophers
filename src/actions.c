...
/*   Updated: 2026/02/18 09:26:30 by lseabra-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_take_forks(t_philosopher *philosopher)
{
	...
	ft_put_msg(philosopher, MSG_FORK, NULL);
...
void	ft_eat(t_philosopher *philosopher)
{
	...
	ft_put_msg(philosopher, MSG_EAT, &philosopher->last_meal);
